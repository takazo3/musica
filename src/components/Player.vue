    ...
    <div class="relative">
      ...
      <div class="float-left w-7 h-7 leading-3">
        <button type="button" @click.prevent="toggleAudio">
          <i class="fa text-rose-400 text-xl" :class="{ 'fa-play':!playing, 'fa-pause':playing }"></i>
        </button>
      </div>
      <!-- Current Position -->
      ...
      <div class="float-left w-7 h-7 leading-3 ml-7 mt-2 player-scrub">
        ...
        <div class="absolute left-0 right-0 text-lg text-center mx-auto player-song-info" v-else="">
          <span class="song-title">Nothing loaded yet</span>
        ...
        <span class="block w-full h-2 rounded m-1 mt-2 bg-gray-200 relative cursor-pointer" @click.prevent="updateSeek">
          ...
          <!-- Player Progress Bar-->
          <span class="block h-2 rounded bg-gradient-to-r from-purple-500 to-rose-400"
